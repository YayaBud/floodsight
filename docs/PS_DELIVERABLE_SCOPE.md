...
| Phuktal river near Sumdo — Mar 2015 | `phutkal` | exists, runs end-to-end, **reports `valid: false`**. Fails G1 (the DEM pool holds 2.97e6 m³ against a configured 2.70e7 m³) and G4 (pool 28.47 m above what the basin holds at 111.6 m cells). Date note: the blockage formed 31 Dec 2014 and breached 7 May 2015, not March. |
